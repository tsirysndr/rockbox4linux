 ...
 *                     \/            \/     \/    \/            \/
 * $Id: pdbox.h 27287 2010-07-05 01:31:57Z wincent $
 *
...
/* Map real keys to virtual ones.
   Feel free to add your preferred keymap here. */
    ...
    #define PDPOD_QUIT (BUTTON_MIDLEFT | BUTTON_MIDRIGHT)
    #define PDPOD_PLAY (BUTTON_TOPMIDDLE | BUTTON_MIDRIGHT)
    #define PDPOD_PREVIOUS (BUTTON_MIDLEFT)
    #define PDPOD_NEXT (BUTTON_MIDRIGHT)
    #define PDPOD_MENU (BUTTON_TOPMIDDLE | BUTTON_BOTTOMMIDDLE)
    #define PDPOD_WHEELLEFT (BUTTON_BOTTOMMIDDLE)
    #define PDPOD_WHEELRIGHT (BUTTON_TOPMIDDLE)
    #define PDPOD_ACTION (BUTTON_TOPMIDDLE | BUTTON_MIDLEFT)
